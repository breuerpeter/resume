...
\photo[circle,edge,right]{01_No_BG_compressed_square.png}
\name{Peter}{Breuer}
\position{Drone Software Engineer}
\address{1420 NE 66th St, Seattle, WA 98115, USA}

\mobile{+41 76 470 25 50}
\email{peter@pbreuer.de}
\dateofbirth{January 21st, 2000}
\homepage{pbreuer.de}
\github{breuerpeter}
\linkedin{peter-breuer}
% \gitlab{gitlab-id}
